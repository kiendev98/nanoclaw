...
flowchart TB
  ...
  subgraph Session["Per-Session Container (Docker)"]
    ...
    MCP["MCP Tools<br/>send_message, send_file, edit_message,<br/>add_reaction, send_card, ask_user_question,<br/>spawn_worker, install_packages, add_mcp_server<br/>CLI: ncl tasks"]
