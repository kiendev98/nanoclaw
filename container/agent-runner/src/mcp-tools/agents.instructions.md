...
Give an agent a `repo` and it works inside a git worktree of that repository, with that repository's `CLAUDE.md`, skills and settings loaded. You stay where you are and hold the conversation. Seven rules:
