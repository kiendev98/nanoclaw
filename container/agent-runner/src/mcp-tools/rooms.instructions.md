...
You cannot create the agents themselves: an agent inside a container creates repo workers (`spawn_worker`) and nothing else. The operator provisions companion agents.
