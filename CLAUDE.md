...
| [docs/worker-reachability.md](docs/worker-reachability.md) | How a worker stays reachable: session/thread binding, escalated questions, and the designed-not-built `answer_worker` + channel-worker work |
